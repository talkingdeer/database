...
По идее, в клиентской части я после отправки команды должен был ожидать сообщений с сервера до тех пор, пока они есть, и только после этого отправлять новую команду. Например, ждать, пока все имена будут выведены. Не придумал, как лучше стоит сообщить серверу, что прислано все, что нужно. Пытался отправлять пустую строку в конце, но тоже нормально не работало. Оставил пока как есть.